...
Configure modeline without icon and showing minor modes and buffer name.
...
Delete all the whitespace when hitting backspace or delete.
...
Assume that I always wnat to kill the current buffer.
